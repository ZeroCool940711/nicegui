            ...
            with python_window(classes="w-full max-w-[44rem]"):
                with ui.column().classes("w-full gap-4"):
                    ...
                    with ui.row().classes("items-center gap-0 w-full px-2"):
                        ...
                        ui.input(on_change=handle_classes).classes(
                            "mt-[-0.5em] text-mono grow"
                        ).props("dense")
                        ui.markdown("`')`")
                    with ui.row().classes("items-center gap-0 w-full px-2"):
                        ...
                        ui.input(on_change=handle_props).classes(
                            "mt-[-0.5em] text-mono grow"
                        ).props("dense")
                        ui.markdown("`')`")
                    with ui.row().classes("items-center gap-0 w-full px-2"):
                        ...
                        ui.input(on_change=handle_style).classes(
                            "mt-[-0.5em] text-mono grow"
                        ).props("dense")
                        ui.markdown("`')`")
                    ui.markdown(
...
def tailwind_demo():
    ...
    ui.label("Label A").tailwind.font_weight("extrabold").text_color(
        "blue-600"
    ).background_color("orange-200")
