...
class Joystick(
    Element, component="joystick.vue", libraries=["lib/nipplejs/nipplejs.js"]
):
    def __init__(
        self,
        *,
        ...
        **options: Any,
        ...
        def handle_start() -> None:
            ...
            handle_event(
                on_start,
                JoystickEventArguments(sender=self, client=self.client, action="start"),
            )
        ...
        def handle_end() -> None:
            ...
            handle_event(
                on_end,
                JoystickEventArguments(sender=self, client=self.client, action="end"),
            )
