...
def test_json():
    ...
    tests = [
        ...
        np.array(
            ["2010-10-17 07:15:30", "2011-05-13 08:20:35", "2013-01-15 09:09:09"],
            dtype=np.datetime64,
        ),
    ...
    for test in tests:
        ...
        assert (
            orjson_str == builtin_str
        ), f"json serializer implementations do not match: orjson={orjson_str}, built-in={builtin_str}"
